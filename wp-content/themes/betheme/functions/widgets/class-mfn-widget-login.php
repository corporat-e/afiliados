		...
		public function widget($args, $instance)
		{
			...
			if (is_user_logged_in()) {
				...
				echo '<div class="author">';
					$userlogin=ucfirst(implode(', ', $user->roles));
					if ($userlogin=="Shop_manager")
					{
					esc_html_e('Logged in as ', 'mfn-opts');
					echo '<strong>'. esc_html(ucfirst(implode(', ', $user->roles))) .'</strong><br />';
					echo '<a href="http://afiliados.corporat-e.com/wp-admin/admin.php?page=wc-admin&path=/analytics/overview">'. esc_html__('Dashboard', 'mfn-opts') .'</a>';
