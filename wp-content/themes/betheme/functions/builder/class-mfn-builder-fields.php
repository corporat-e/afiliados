   				...
   				'fields' => array(
   					...
   					// embed
						...
						array(
							...
							'link' => 'admin.php?page=be-options#advanced&options',
						),
				...
				'dropcap' => array(
					...
					'fields' => array(
						...
						array(
							'id' => 'circle',
							'type' => 'switch',
							'title' => __('Circle', 'mfn-opts'),
							'desc' => __('The look of dropcap', 'mfn-opts'),
							'options' => array(
								'0' => __('No', 'mfn-opts'),
								'1' => __('Yes', 'mfn-opts')
							),
						...
						array(
							...
							'type' => 'switch',
							'title' => __('Size', 'mfn-opts'),
							'desc' => __('The size of dropcap', 'mfn-opts'),
							'options' => array(
								'1' => __('Small', 'mfn-opts'),
								'2' => __('Normal', 'mfn-opts'),
								'3' => __('Large', 'mfn-opts')
							),
							'std' => '1'
						),
				...
				'google_font' => array(
					...
					'fields' => array(
						...
						array(
							...
							'type' => 'text',
							'title' => __('Font', 'mfn-opts'),
							'desc' => __('Google font name', 'mfn-opts'),
							'std' => 'Open Sans'
						),
