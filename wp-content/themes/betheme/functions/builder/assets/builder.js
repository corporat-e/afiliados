  ...
  var MfnBuilder = (function($) {
    ...
    var introduction = {
      ...
      open: function(){
        ...
        $('.mfn-intro-container ul').on('afterChange', function(event, slick, currentSlide, nextSlide){
    ...
    var shortcodeEditor = {
      ...
      createShortcodeBuilder( buttonName, closestDomLocation ){
        ...
        if( 'share_box' == buttonName ){
          ...
          wp.codeEditor.mfnFieldTextarea.methods.addCodeIntoTextArea('[sharebox]');
