...
function mfn_visual_builder(){
	...
	function mfnvb_ce_live_button($post) {
		...
		if(isset($post->post_name) && $post->post_type == 'page') echo '<div style="float: right; margin: 15px 0;" class="mfn-live-edit-page-button"><a href="' .admin_url('/post.php?post='. $post->ID .'&action=mfn-live-builder'). '" class="mfn-btn mfn-switch-live-editor button-hero mfn-btn-green button button-primary">Edit with Live Builder</a></div>';
	}
